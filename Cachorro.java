...
public class Cachorro extends AnimalTerrestreAB {
    ...
    public Cachorro(double comIn, double camPer, double horSo) {
    ...
    public void moverse() {
        ...
        System.out.println(
                "Ontem o cachorro andou " + this.caminhoPercorrido + "km com as suas " + this.getQuantPatas()
                        + " patas.");
        this.caminhoPercorrido = this.caminhoPercorrido + mover;
        System.out.println(
                "O cachorro andou mais " + mover + "km hoje. No total ele percorreu " + this.caminhoPercorrido
                        + "km.\n");
    ...
    public void dormir() {
        ...
        System.out.println("Ontem o cachorro dormiu " + this.horasDeSono + " horas.");
        this.horasDeSono = this.horasDeSono + dormiu;
        System.out.println("O cachorro dormiu por " + dormiu
